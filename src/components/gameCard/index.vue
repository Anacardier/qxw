    ...
    >
      ...
      <div class="content">
        ...
        <div class="game-footer">
          <div
            :class="item.collection == 1 ? 'collection animation-barJump active' : 'collection animation-barJump'"
          >
            <font-awesome-icon
          ...
          <div
            :class="item.test == 1 ? 'game-test animation-barJump active' : 'game-test animation-barJump'"
          >
